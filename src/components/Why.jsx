function Why() {
    return (
        <div className="flex flex-row items-center justify-start min-w-[1240px]  min-h-[80vh]">
            <div className="flex flex-col items-start justify-center w-[50%] pl-[150px]">
            ...
            <div className="flex items-center justify-center w-[50%] pr-10">
                ...
                <img className="absolute right-10 z-10" src="https://res.cloudinary.com/djoebsejh/image/upload/v1717331425/Prescription_Testres/hqpb7nlxpbchjnrviezm.png" alt="hold" />
                <img className="absolute right-1 z-0" src="https://res.cloudinary.com/djoebsejh/image/upload/v1717306659/Prescription_Testres/j6tkve6awbzxg4bhugxp.png" alt="eclipse" />
                {/* SVG */}
